...
pdf(file="/public/ZhangJinLab/project_erv/Dpan/IPSAnaly/M1M2_diffanaly_cluster_CD206.pdf",width=10,height=10)
...
pdf(file="/public/ZhangJinLab/project_erv/Dpan/IPSAnaly/M1M2_diffanaly_nocluster_CD206.pdf",width=10,height=10)
