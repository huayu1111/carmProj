...
pdf(file="/public/ZhangJinLab/project_erv/Dpan/IPSAnaly/M1M2_metabolic_cluster_CD86.pdf",width=10,height=10)
...
pdf(file="/public/ZhangJinLab/project_erv/Dpan/IPSAnaly/M1M2_metabolic_nocluster_CD86.pdf",width=10,height=10)
